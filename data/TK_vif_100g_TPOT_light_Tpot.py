# TPOTClassifier(verbosity=2,generations=100,config_dict=TPOT light,max_time_mins=None,random_state=42,early_stop=3)# ifile data/TK_vif.csv  model=TPOT_light Tpot_file=data/TK_vif_100g_TPOT_light_Tpot.py, Tpot_score=0.314214463840399, starttime2020-07-17 12:32:53.926867, endtime=2020-07-17 19:04:24.712583 duration=6:31:30
import numpy as np
import pandas as pd
