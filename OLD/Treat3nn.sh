...
#./Treat3.py --ifile data/TK_vif.csv --model GB --generations 100

./Treat3.py --ifile data/TK.csv --model "Tpot_nn"
./Treat3.py --ifile data/TK_vif.csv --model "Tpot_nn"
./Treat3.py --ifile data/TK_vif_cap2.csv --model "Tpot_nn"
